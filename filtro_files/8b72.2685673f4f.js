...
__d((function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.BaseBigSearchForm=void 0;var n=babelHelpers.interopRequireWildcard(r(d[0])),l=r(d[1]),o=r(d[2]),t=r(d[3]),s=babelHelpers.interopRequireDefault(r(d[4])),c=r(d[5]),u=babelHelpers.interopRequireDefault(r(d[6])),v=r(d[7]),b=babelHelpers.interopRequireDefault(r(d[8])),_=r(d[9]);const f=`/${o.SEARCH_ENDPOINT}/${o.TAB_PATHS[o.EXPLORE_TABS.ALL]}`;const p=(0,u.default)('BigSearchBarForm',['onFocus'])((function({active:o,children:u,formHeader:p,onFocus:B=(()=>{}),onOutsideFocus:h,onSubmit:R,searchButton:S,selectedTabId:T,css:A,styles:F,linariaClassNames:N}){const y=(0,t.useImmersive)(),C=(0,c.useCx)(),x=(0,n.useCallback)(n=>{var l;const o='buttons'in n||'touches'in n?n.target:'relatedTarget'in n?n.relatedTarget:null;(null==o||null===(l=o.closest)||void 0===l?void 0:l.call(o,'[role=dialog]'))||null==h||h()},[h]),{ref:E,onBlur:H}=(0,b.default)(x);return(0,s.default)(E,x),(0,_.jsxs)("form",{className:C(null==N?void 0:N.form),...(0,l.maybeRwsCss)(A,null==F?void 0:F.form),onBlur:H,onFocus:B,ref:E,action:f,method:"get",onSubmit:R,role:"search",children:[p,(0,_.jsxs)("div",{"aria-labelledby":T,id:"search-tabpanel",role:"tabpanel",tabIndex:0,className:C(null==N?void 0:N.container,y&&(null==N?void 0:N.container_immersive),o?null==N?void 0:N.container_active:null==N?void 0:N.container_inactive),...(0,l.maybeRwsCss)(A,null==F?void 0:F.container,y?null==F?void 0:F.container_immersive:null==F?void 0:F.container_standard,o?null==F?void 0:F.container_active:null==F?void 0:F.container_inactive),[v.PANEL_BOUNDS_DATA_ATTRIBUTE]:!0,children:[(0,_.jsx)("div",{className:C(null==N?void 0:N.inputs),...(0,l.maybeRwsCss)(A,null==F?void 0:F.inputs),children:u}),S&&(0,_.jsx)("div",{className:C(null==N?void 0:N.button),...(0,l.maybeRwsCss)(A,null==F?void 0:F.button),children:S})]})]})}));e.BaseBigSearchForm=p;(0,l.deprecatedExtendableStylesFn)('BaseBigSearchForm',()=>({form:{},container:{},container_active:{},container_inactive:{},inputs:{},button:{}}))}),"050b77",["d7ed8e","0acceb","87d380","421e67","735ae2","5f1f1f","bc1c90","b88c64","185e34","721ed1"]);
...
__d((function(g,r,i,a,m,e,d){"use strict";Object.defineProperty(e,"__esModule",{value:!0}),e.default=function({expanded:j=!1,bigSearch:S,littleSearch:_}){const k=(0,s.useImmersive)(),y=(0,c.useCx)(),[q,w]=(0,t.useState)(!1),[z,C]=(0,t.useState)(k);return(0,t.useEffect)(()=>{let t=!0;return l.scheduler.postTask(()=>{t&&w(!0)},{priority:'user-visible',event:'hydrate-complete'}),()=>{t=!1}},[]),(0,t.useEffect)(()=>{j&&C(k)},[j,k]),(0,u.jsxs)(u.Fragment,{children:[(0,u.jsx)("div",{className:y(n,q&&p,j?b:o),children:_}),(0,u.jsx)(s.ImmersiveContext.Provider,{value:z,children:(0,u.jsx)("div",{className:y(v,q&&x,j?h:f),children:S})})]})};var t=babelHelpers.interopRequireWildcard(r(d[0])),s=(r(d[1]),r(d[2])),l=(r(d[3]),babelHelpers.interopRequireDefault(r(d[4])),r(d[5])),c=r(d[6]),u=(r(d[7]),r(d[8]));const n="lkm6i7z",o="lr5v90m",b="l1h6eamc",p="l1rzxhu2",v="b3ppcw1",h="b1kj223i",f="b12rw3s8",x="b1t24mo5"}),"8d21c1",["d7ed8e","f03cc4","421e67","90390a","8b41f4","cc3672","5f1f1f","915fa3","721ed1"]);
...
__r("6898d5").extend({"shared.Search":"Buscar","search.voiceover.VoiceOver_instructions_for_navigating_list_of_search_suggesions":"Navega hacia adelante para acceder a los resultados sugeridos","flexible_date_search.When":"Cuándo","flexible_date_search.super_flexibility.super_flexible_trip_dates.any_time":"Cualquier fecha","shared.clearInput":"Borrar datos","dora.searchinput.map_area":"Área del mapa"});
//# sourceMappingURL=https://sourcemaps.d.musta.ch/airbnb/static/packages/web/common/8b72.167b6d26d0.js.map